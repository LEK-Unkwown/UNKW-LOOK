...
stderr.writelines(f"""{Gr}
  _   _   _   _   _  __ __        __    _        ___     ___    _  __
 | | | | | \ | | | |/ / \ \      / /   | |      / _ \   / _ \  | |/ /
 | | | | |  \| | | ' /   \ \ /\ / /    | |     | | | | | | | | | ' / 
 | |_| | | |\  | | . \    \ V  V /     | |___  | |_| | | |_| | | . \ 
  \___/  |_| \_| |_|\_\    \_/\_/      |_____|  \___/   \___/  |_|\_\
                                                                     

          {Wh}[ + ]  C O D E R  P A R  _Unkwown_  [ + ]  
        
    {Wh}[ 1 ] {Gr}IP Tracker
    {Wh}[ 2 ] {Gr}Montrez Votre IP
    {Wh}[ 3 ] {Gr}Numero Tracker
    {Wh}[ 4 ] {Gr}Pseudo Tracker
    {Wh}[ 0 ] {Gr}Quitter
""")

input_user = input(f'\n   {Wh}@UNKW~# {Gr}') #OPSI MENU
...
if input_user == '1': #OPSI 1
 ...
 ____ ___ _______    ____  __. __      __  
|    |   \\      \  |    |/ _|/  \    /  \ 
|    |   //   |   \ |      <  \   \/\/   / 
|    |  //    |    \|    |  \  \        /  
|______/ \____|__  /|____|__ \  \__/\  /   
    ...
    try:
        def IP_Track():
            ...
            print(f"{Wh} Domaine          :{Gr}", ip_data["connection"]["domain"])
...
""")
    ...
    print(f"\n  {Wh}[{Ye}!{Wh}] {Ye}THANK'S FOR USING TOOL {Ye}UNKW LOOK !")
else:
